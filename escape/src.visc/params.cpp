...
char sSurface [255], sSpectraDir [255], sMultDir [255], sSurfacedens [255] ;
...
void readParams(char* filename)
{
  ...
  deta=0.1 ; dx=dy=0.0 ;
	...
	else if(strcmp(parName,"densities")==0) strcpy(sSurfacedens, parValue) ;
   ...
   else if(strcmp(parName,"deta")==0) deta = atof(parValue) ;
